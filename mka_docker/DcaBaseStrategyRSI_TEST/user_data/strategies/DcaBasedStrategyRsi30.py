...
class DcaBasedStrategyRsi30(IStrategy):
    ...
    def load_dca_orders(self):
        try:
            ...
            if os.path.exists('user_data/dca_orders_30'):
                with open('user_data/dca_orders_30', 'rb') as handle:
    ...
    def save_dca_orders(self):
        try:
            with open('user_data/dca_orders_30', 'wb') as handle:
